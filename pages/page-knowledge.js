  ...
  container.innerHTML = `
    <div class="fade-in max-w-4xl px-4">
      <div class="section-title-area">
        ...
        <p class="text-text-muted">Feed your agent specialized text or web content.</p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="space-y-4">
          <div class="card h-full flex flex-col">
            <h3 class="font-bold mb-4 flex items-center gap-2">
              <i data-lucide="file-text" class="w-5 h-5 text-primary"></i> Text Knowledge
            </h3>
            <textarea id="text-input" class="input flex-1 mb-3 min-h-[150px]" placeholder="Paste FAQ, product info, or any text context here..."></textarea>
            <button id="add-text-btn" class="btn btn-secondary w-full text-sm">Add Text Snippet</button>
        ...
        <div class="space-y-4">
          <div class="card h-full flex flex-col">
            <h3 class="font-bold mb-4 flex items-center gap-2">
              <i data-lucide="link" class="w-5 h-5 text-primary"></i> Website URLs
            </h3>
            <div class="flex gap-2 mb-3">
              <input type="url" id="url-input" class="input text-sm" placeholder="https://example.com/info">
              <button id="add-url-btn" class="btn btn-secondary text-sm whitespace-nowrap">Add URL</button>
            </div>
